...
function RightSidebar() {
  ...
  const {selectedUser, messages, selectedProfile, setSelectedProfile} = useContext(ChatContext);
    ...
    selectedProfile && selectedUser && (
      <div className={`bg-[#8185B2]/10 text-white w-full relative overflow-y-scroll ${selectedUser ? "max-md:hidden" : ""}`}>
        ...
        <div className="px-5 text-xs">
            <p>Media</p>
            <div className="mt-2 max-h-[400px] overflow-y-scroll grid grid-cols-3 gap-4 opacity-80 ">
